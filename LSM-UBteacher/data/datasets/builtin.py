...
_SPLITS_COCO_FORMAT["coco"] = {
    ...
    "coco_unlabel_1":(
        "coco/train2017",
        "coco/annotations/instances_unlabel_1.json",
    ),
    "coco_unlabel_2":(
        "coco/train2017",
        "coco/annotations/instances_unlabel_2.json",
    ),
    "coco_unlabel_5":(
        "coco/train2017",
        "coco/annotations/instances_unlabel_5.json",
    ),
    "coco_unlabel_10":(
        "coco/train2017",
        "coco/annotations/instances_unlabel_10.json",
    ),
}
